    ...
    <Container maxW={{base:'container.xl',lg:'container.md',xl:'container.lg','2xl':'container.xl'}}  py='20'>
      ...
      <Flex direction={{base:'column',lg:'row'}} pt='10' gap='4'  >
        <Stack flex='4' spacing='10'>
            <Heading>「カオの見える生産者」と「食材のチカラを活かす」焼鳥・ジビエ・ワインの店</Heading>
            <Text>化学抗生物質、配合飼料を一切使用せず自然飼育された「黒岩土鶏」を中心に部位の特徴を活かし調理した焼鳥。そしてマタギから直接届く鹿、猪等のジビエを炭火の良さを活かしシンプルに、また時に枠にとらわれない調理をすることで最高の食を提供いたします</Text>
            <Stack  direction={{base:'column',lg:'row'}} justifyContent='space-between' align='center'spacing='2'  >
            <Box>
              <Image src='/焼き鳥4.JPG' alt='top' boxSize='80' ></Image>
            </Box>
            <Box>
